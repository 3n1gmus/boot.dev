...
def get_create_bits(user_permissions):
    result = can_create_guild & user_permissions
    return result


def get_review_bits(user_permissions):
    result = can_review_guild & user_permissions
    return result


def get_delete_bits(user_permissions):
    result = can_delete_guild & user_permissions
    return result


def get_edit_bits(user_permissions):
    result = can_edit_guild & user_permissions
    return result
